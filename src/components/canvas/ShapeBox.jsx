...
const ShapeBox = ({ setTool }) => {
	return (
		...
		<div class='w-1/3 h-full border-2 border-primary grid grid-cols-3 items-center rounded-md pl-2 pr-2 bg-neutral-500'>
			<button onClick={() => setTool('pen')} class='flex items-center justify-center'>
			...
			<button onClick={() => setTool('eraser')} class='flex items-center justify-center'>
				<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 576 512' width='25' height='25'>
					<path
						fill='#ffffff'
		...
		<div class='w-1/3 h-full border-2 border-primary grid grid-cols-3 items-center rounded-md pl-2 pr-2 bg-neutral-500'>
			<button onClick={() => setTool('square')} class='flex items-center justify-center'>
			...
			<button onClick={() => setTool('line')} class='flex items-center justify-center'>
			...
			<button onClick={() => setTool('circle')} class='flex items-center justify-center'>
